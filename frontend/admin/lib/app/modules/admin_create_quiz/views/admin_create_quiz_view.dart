...
// View for creating quizzes. Supports adding multiple questions per card,
// selecting correct options, uploading a thumbnail, and editing questions
// inline. Uses GetX reactive primitives (Rx, Obx) to manage local state.
class AdminCreateQuizView extends GetResponsiveView {
  ...
  final RxList<Map<String, dynamic>> questionsInCard =
      <Map<String, dynamic>>[].obs;
  final Rx<Uint8List?> selectedThumbnail = Rx<Uint8List?>(null);
  final RxInt editingQuestionIndex = (-1).obs;

  // Pick image for the quiz thumbnail and store bytes in `selectedThumbnail`.
                          ...
                          Expanded(
                            ...
                            child: Column(
                              children: [
                                ...
                                const SizedBox(height: 20),
                                _buildDropdown("Quiz Type", [
                                  "Lesson Quiz",
                                  "MCQ",
                                ]),
                                const SizedBox(height: 20),
                                _buildDropdown("Quiz Appearance", [
                                  "Before",
                                  "In Between",
                                  "After",
                                ]),
                          ...
                          Expanded(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  height:
                                      600, // Increased height to show all 4 options
                                  padding: const EdgeInsets.all(20),
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: SingleChildScrollView(
                                          ...
                                          child: Obx(
                                            () => Column(
                                              children: questionsInCard.asMap().entries.map((
                                                entry,
                                              ) {
                                                int index = entry.key;
