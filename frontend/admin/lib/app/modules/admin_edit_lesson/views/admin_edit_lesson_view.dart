...
class AdminEditLessonView extends GetResponsiveView {
  ...
  final RxList<String> existingFiles = <String>["Syllabus.pdf", "Chapter-1.pdf", "Chapter-2.pdf"].obs;
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: Column(
                              children: [
                                _buildTextField(Get.context!, "Lesson Title",
                                    "enter lesson title"),
                                const SizedBox(height: 20),
                                _buildTextField(Get.context!,
                                    "Lesson Description", "enter lesson description"),
                                const SizedBox(height: 20),
                                _buildThumbnailUploadBox(Get.context!, "Upload Thumbnail",
                          ...
                          Expanded(
                            ...
                            child: Column(
                              children: [
                                ...
                                const SizedBox(height: 20),
                                _buildTextField(
                                    Get.context!, "Cost", "enter lesson cost"),
                                const SizedBox(height: 20),
                                _buildDropdown(Get.context!, "Class",
                                    List.generate(5, (i) => "Class ${i + 1}")),
                                const SizedBox(height: 20),
                                _buildDropdown(Get.context!, "Subject",
                                    List.generate(5, (i) => "Subject ${i + 1}")),
                                const SizedBox(height: 20),
                                _buildDropdown(Get.context!, "Chapter",
                                    List.generate(5, (i) => "Chapter ${i + 1}")),
                                const SizedBox(height: 20),
                                _buildDropdown(Get.context!, "Lesson",
  ...
  static Widget _buildTextField(BuildContext context, String label, String hint,
      {int maxLines = 1}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
