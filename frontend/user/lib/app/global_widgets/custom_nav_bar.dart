...
class CustomBottomNavBar extends StatelessWidget {
  ...
  /*
    CustomBottomNavBar
    - Purpose: Simple BottomAppBar for the user app with four navigation items.
    - Notes: Purely presentational. Keep callbacks simple (index-based). Header
      comment added 2025-10-23.
  */
