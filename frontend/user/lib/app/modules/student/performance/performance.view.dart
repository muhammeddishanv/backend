...
/*
  PerformanceView
  - Purpose: Shows user progress, ranking, and stats in a responsive layout.
  - Notes: Mostly presentational; controller provides data. Header added
    2025-10-23 (annotation only).
*/
