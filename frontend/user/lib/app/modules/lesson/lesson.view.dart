...
/*
  LessonView
  - Purpose: Presents a lesson page with progress, video preview placeholder,
    instructor info, and chapter list. Uses Obx to react to chapter expansion.
  - Notes: Keep UI-only; controller manages chapter state and navigation.
