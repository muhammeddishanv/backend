...
import 'package:ed_tech/app/modules/home/home.view.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

// Dummy controller for SubCategoryView
class SubCategoryController extends GetxController {}

class SubCategoryView extends GetResponsiveView<SubCategoryController> {
  ...
  final List<_CategoryOption> _options = const [
    _CategoryOption(label: 'Category 1', icon: Icons.category),
    _CategoryOption(label: 'Category 2', icon: Icons.category),
    _CategoryOption(label: 'Category 3', icon: Icons.category),
    _CategoryOption(label: 'Category 4', icon: Icons.category),
    _CategoryOption(label: 'Category 5', icon: Icons.category),
    _CategoryOption(label: 'Category 6', icon: Icons.category),
  ];
