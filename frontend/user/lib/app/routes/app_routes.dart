...
/*
  app_routes.dart
  - Purpose: Centralized route name constants used across the user app.
  - Notes: Constants follow autogenerated-style naming; they intentionally use
    uppercase. Header added 2025-10-23 for clarity.
*/
